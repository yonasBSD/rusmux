...
- Removed unmaintained yaml-rust

### Documentation

- Applied formatting and liniting hints to README.md
- Added to README example of running with a path to file

### Features

- Changed alias to visible_alias
- Added ls alias to list command

### Miscellaneous Tasks

- Cleaned clippy warnings
